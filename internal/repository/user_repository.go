...
func (s UserRepository) SelectUserByUsername(ctx context.Context, username string) (entity.User, error) {
...
func (s UserRepository) SelectUserByID(ctx context.Context, userID string) (entity.User, error) {
	var user entity.User
...
func (s UserRepository) SelectAllUsers(ctx context.Context) ([]entity.User, error) {
